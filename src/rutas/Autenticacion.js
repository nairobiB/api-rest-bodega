...
rutas.post(
  ...
  body("correo")
    .notEmpty()
    .withMessage("Debe escribir el correo del usuario")
    .isEmail()
    .withMessage("Debe escribir una dirección de correo válida"),
...
rutas.put(
  ...
  query("usuario")
    .notEmpty()
    .withMessage("Debe escribir el correo o nombre de usuario")
    .isLength({ min: 3 })
    .withMessage(
      "Debe escribir un correo o nombre de usuario de 3 caracteres como mínimo"
    ),
  body("pin")
    .notEmpty()
    .withMessage("Debe escribir el correo o nombre de usuario")
    .isLength({ min: 4, max: 4 })
    .withMessage("Debe escribir un pin de 4 caracteres"),
  body("contrasena")
    .notEmpty()
    .withMessage("Debe escribir la contraseña de usuario")
