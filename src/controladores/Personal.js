...
exports.Guardar = async (req, res) => {
  ...
  if (!validacion.isEmpty()) {
    ...
    const { nombreCompleto, direccion, correo_Personal, telefono, fechaNac, RolId, SucursalId } = req.body;
    console.log(nombreCompleto);
    if (!nombreCompleto || !direccion || !correo_Personal || !telefono || !fechaNac || !RolId || !SucursalId) {
  ...
  if (!id) {
    ...
    if (!nombreCompleto || !direccion || !correo_Personal || !telefono || !fechaNac || !RolId || !SucursalId) {
      ...
      if (!buscarPersonal) {
        ...
        buscarPersonal.correo_Personal = correo_Personal;
